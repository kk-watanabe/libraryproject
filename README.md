...
## 分散型図書館『テック図書館』
数万冊の本が眠る架空のビルがあるとします。<br>

<br>

本アプリは、ビル内のあちこちに分散している数万冊の本をそれぞれの本棚に保管したまま一元管理する分散型図書館システムです。<br>
...
| シンプルなログイン画面です。<br>ブラウザを閉じてもログイン状態を保持できます。 | サインアップ画面です。<br>ヴァリデーション設定を組み込んでいます。 |
...
- 保存場所エンティティ &rArr; 各本棚の本のフィルタリングを効率化
...
## 今後の展望
今後は、JavaScriptやReact, Angularなどのフロントエンド技術を習得し、利用者目線でUI・UXまで改善できる力を身につけたいと考えています。また、企業の現場で使うことを意識して、セキュリティ面（権限、エラー処理、ヴァリデーション、通知）でのより堅固な実装を目指していきます。
